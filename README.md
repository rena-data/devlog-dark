...
| 버전 | 날짜 | 주요 변경사항 |
|------|------|-------------|
| v1.1 | 2026-05-21 | 반응형 5단계 breakpoint, SEO(Schema.org JSON-LD), 성능 최적화(font-display swap, defer, passive, preload), 구독 네임카드 일원화, 코드블럭 가시성 강화, 다크모드 인용/테이블/광고 오버플로 수정, 스크롤 버튼 항상 표시, 분류 전체보기 → 전체 글 텍스트 변경, 불필요 코드 정리 |
